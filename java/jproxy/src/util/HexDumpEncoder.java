/*
 * @(#)HexDumpEncoder.java	1.5 95/09/06 Chuck McManis
 *
...
public class HexDumpEncoder extends CharacterEncoder {
  ...
  return (16);
    ...
    void encodeBufferPrefix(OutputStream o) throws IOException {
  offset = 0;
  super.encodeBufferPrefix(o);
    }

    void encodeLinePrefix(OutputStream o, int len) throws IOException {
  ...
  thisLineLength = len;
    ...
    void encodeAtom(OutputStream o, byte buf[], int off, int len) throws IOException {
  ...
  if (currentByte == 8)
    ...
    void encodeLineSuffix(OutputStream o) throws IOException {
